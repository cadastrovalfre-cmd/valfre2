// api/tiny-produto-detalhe.js
// Busca detalhes completos de um produto: descrição, imagens, peso, garantia etc.
module.exports = async function handler(req, res) {
  ...
  try {
    const params = new URLSearchParams({ token, id: String(id), formato: 'JSON' });
